...
> Design notes for **fintech-checkout-asset-upload** — a runnable typescript example that Typed checkout service that risk-checks payment assets before issuing presigned browser upload URLs.
...
- **Feature code** — the actual task: risk-checked-payment-assets.
